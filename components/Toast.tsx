...
export default function Toast({ message }: { message: string | null }) {
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 rounded-sm border border-navy-line bg-navy text-paper px-4 py-2.5 shadow-card-hover font-mono text-xs uppercase tracking-wide">
